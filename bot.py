...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(f"أهلاً {user.full_name}! حبيبي البوت لزيادة تفاعل قناتك : {CHANNEL_ID}", reply_markup=reply_markup)
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await query.edit_message_text("😂✍️ أرسل رابط منشورك الجديد:")
